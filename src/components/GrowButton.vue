<template>
    <div 
        @click="textClick"  
        class="relative disable-text-select grow md:h-8 lg:h-14 xl:h-16 flex justify-center items-center rounded lg:rounded-lg shadow-md hover:bg-gray-100 bg-gray-50 hover:cursor-pointer" 
